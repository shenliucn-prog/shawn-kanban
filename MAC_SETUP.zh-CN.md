...
[English](MAC_SETUP.md) | **简体中文** · [返回 README](README.zh-CN.md)

本指南用于 Mac 提供局域网数据的场景。仅使用云端图片时，直接按 [Kindle 安装说明](README.zh-CN.md#kindle-安装与升级)部署插件，无需在 Mac 启动服务。
...
城市、股票和端口配置见 [README](README.zh-CN.md#配置configjson-或环境变量环境变量优先)。
...
本机历史或数据库不存在时，对应活动数据可能不可用；AI 指标是估算值，详见 [云端部署说明](docs/CLOUD_DEPLOY.zh-CN.md#本机额度上报迁移)。
